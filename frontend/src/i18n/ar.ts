...
export const ar: Record<string, string> = {
  ...
  "Recorded outage history — survives restarts, unlike the live monitor.":
    "سجل الانقطاعات المحفوظ — يبقى بعد إعادة التشغيل، بخلاف المراقبة الحية.",
  "IPs with outages": "عناوين تعرّضت للانقطاع",
  "Outages recorded": "الانقطاعات المسجّلة",
  "Total downtime": "إجمالي مدة الانقطاع",
  "Still down": "ما زالت منقطعة",
  "By IP": "حسب العنوان",
  "Every outage": "كل الانقطاعات",
  "Tower": "البرج",
  "Downtime": "مدة الانقطاع",
  "Outages": "الانقطاعات",
  "Last outage": "آخر انقطاع",
  "Went down": "وقت الانقطاع",
  "Came back": "وقت العودة",
  "Duration": "المدة",
  "down now": "منقطع الآن",
  "still down": "ما زال منقطعاً",
  "No outages recorded in this period. Everything has been up.":
    "لا توجد انقطاعات مسجّلة في هذه الفترة. كان كل شيء يعمل.",
  "{n}d": "{n} يوم",
  "{n}m {s}s": "{n} دقيقة و{s} ثانية",
  "{n}s": "{n} ثانية",
  "{n}m": "{n} دقيقة",
