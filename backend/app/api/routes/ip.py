...
async def list_ip(db: AsyncSession = Depends(get_db), user: User = Depends(require_role("editor"))):
    # IP allocations carry master/slave/switch credentials — restrict to editor+
